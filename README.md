...
1. Setup python and conda on the laptop you will use during the course: [setup_python_with_anaconda.md](./setup/setup_python_with_anaconda.md) (also see [setup_macos.md](./setup/setup_macos.md) if you are macOS user)
...
4. create external accounts
    ...
    2. _optional_: Create a Hugging Face _pro_ account and API key (): : [setup_hugging_face_pro.md](./setup/setup_hugging_face_pro.md)
    3. _optional_: Create an OpenAI account and API key (optionally, upgrade to _Pro_): [setup_openai.md](./setup/setup_openai.md)
